...
```{r three, echo=FALSE}
plot_profit <- data.frame(Profit_052019_062019 = control_resturants$Profit_052019_062019, 
...
plot_income <- data.frame(Income_052019_062019 = control_resturants$Income_052019_062019, 
...
```{r four, echo=FALSE}
plot_Staff <- data.frame(Staff_052019_062019 = control_resturants$Number_Of_Staff_Before_Covid, 
                         Staff_052020_062020 = control_resturants$Number_Of_Staff_During_Covid, 
                          Staff_052021_062021 = control_resturants$Number_Of_Staff_During_Reopen)
