---
title: "Reopening During a Pandemic Stimulated Staffing and Profit, but Reviews on Helpfulness Showed Mixed Reviews"
...
In an effort to avoid further devastation to the restaurant community, Petit Poll has collaborated with the Ontario Government to examine the effects of COVID-19 on restaurants in Toronto and understand what provisions can be made. This paper will first explore the effects of COVID-19 on the restaurant industry from 2019-2020 using Dinesafe data from the City of Toronto. We will then continue to investigate specific findings from the survey by comparing data from the control and treatment groups. We will finally end on a discussion about the greater implications of our study, limitations and possible expansions. 
...
#Franchise
# kbl(tabyl(all_pop_resturants$Franchise, sort = TRUE), booktabs = T, col.names = c("Franchise (Y/N)", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "Number of restaurants franchised") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
...
# kbl(tabyl(all_pop_resturants$Business_Operation_Year, sort = TRUE), booktabs = T, col.names = c("Years in Business", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "Number of years in operation") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
...
# #Own / Lease
# kbl(tabyl(all_pop_resturants$Own_Lease, sort = TRUE), booktabs = T, col.names = c("Restaurant Ownership", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "Number of restaurants who own the property") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
...
# #Pricepoint
# kbl(tabyl(all_pop_resturants$Price_Point_Target, sort = TRUE), booktabs = T, col.names = c("Price-Point", "Number of Restaurants", "Percent of Restaurants"), 
#     align = c("l", "l", "l"), caption = "Price-point of restaurants") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
...
# kbl(tabyl(sample_low_end_rest$Helpfulness, sort = TRUE), booktabs = T, col.names = c("Helpfulness on 5-Point Scale", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "High-end restaurant esponses to helpfulness on a 5-point scale") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
# #average split of 33%
...
tabyl(sample_low_end_rest$Helpfulness, sort = TRUE) %>%
  adorn_pct_formatting() %>%
  kbl(booktabs = T, col.names = c("Helpfulness on 5-Point Scale", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "Low-end restaurant esponses to helpfulness on a 5-point scale") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position") %>%
  kable_styling(latex_options = c("striped", "scale-down"))
...
# kbl(tabyl(sample_average_rest$Helpfulness, sort = TRUE), booktabs = T, col.names = c("Helpfulness on 5-Point Scale", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "Middle-end restaurant responses to helpfulness on a 5-point scale") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
# #average split of 33%
...
# kbl(tabyl(sample_high_end_rest$Helpfulness, sort = TRUE), booktabs = T, col.names = c("Helpfulness on 5-Point Scale", "Number of Restaurants", "Percent of Restaurants"), align = c("l", "l", "l"), caption = "High-end restaurant esponses to helpfulness on a 5-point scale") %>%
#   kableExtra::kable_styling(latex_options = "HOLD_position") %>%
#   kable_styling(latex_options = c("striped", "scale-down"))
# #average split of 33%
